# docker build -t lucwastiaux/baserow-clt:1.18.0-6.2-a -f baserow_clt.Dockerfile .
# docker push lucwastiaux/baserow-clt:1.18.0-6.2-a
...
RUN . /baserow/venv/bin/activate && pip3 install sentry-sdk==1.10.1 && pip3 cache purge
