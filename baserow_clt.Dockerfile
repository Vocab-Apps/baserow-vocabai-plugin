# docker build -t lucwastiaux/baserow-clt:1.19.1-11.0.3-a -f baserow_clt.Dockerfile .
# docker push lucwastiaux/baserow-clt:1.19.1-11.0.3-a
...
RUN . /baserow/venv/bin/activate && pip3 install clt_requirements==1.6 && pip3 cache purge
RUN . /baserow/venv/bin/activate && pip3 install cloudlanguagetools==11.0.3 && pip3 cache purge
