# docker build -t lucwastiaux/baserow-clt:1.12.0-3.2-B -f baserow_clt.Dockerfile .
# docker push lucwastiaux/baserow-clt:1.12.0-3.2-B
...
RUN . /baserow/venv/bin/activate && pip3 install cloudlanguagetools==3.2 && pip3 cache purge
