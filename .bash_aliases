...
alias test='${DOCKER_EXEC_COMMAND} /baserow.sh backend-cmd bash -c "pytest --reuse-db /baserow/data/plugins/baserow_vocabai_plugin/backend/tests"'
alias test_clt='${DOCKER_EXEC_COMMAND} /baserow.sh backend-cmd bash -c "CLOUDLANGUAGETOOLS_CORE_TEST_SERVICES=yes pytest --reuse-db /baserow/data/plugins/baserow_vocabai_plugin/backend/tests"'