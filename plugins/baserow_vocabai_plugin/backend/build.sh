...
# git diff baserow-1.17.2..baserow-vocabai-patch-1.17.2 | sed "s:/deploy/all-in-one/:/:g" > ~/python/baserow-vocabai-plugin/plugins/baserow_vocabai_plugin/baserow-patches/baserow.patch
